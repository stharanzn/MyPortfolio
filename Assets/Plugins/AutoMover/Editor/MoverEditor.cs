...
namespace AutoMoverFree
{
    ...
    public class MoverEditor : Editor
    {
        ...
        private static readonly GUIContent moveUpButtonContent = new GUIContent("\u25b2", "move up");
        private static readonly GUIContent moveDownButtonContent = new GUIContent("\u25bc", "move down");
        private static readonly GUIContent duplicateButtonContent = new GUIContent("+", "duplicate");
        private static readonly GUIContent deleteButtonContent = new GUIContent("-", "delete");
        private AutoMover mover;
        private bool expandedAnchorPoint;
        ...
        SerializedProperty anchorPointExpanded;
        ...
        void OnEnable()
        {
            //Finding the initial/saved values for all parameters
        ...
        public override void OnInspectorGUI()
        {
            ...
            //Drawing the list of anchor points
            CustomListField(waypointPos, waypointRot);

            #region Curve foldout
            ...
            if (expandedCurve)
            {
                ...
                EditorGUILayout.PrefixLabel(new GUIContent("Length (seconds)", "Specifies the length of the curve in seconds. Minimum value of 0.5f."));
                ...
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.PrefixLabel(new GUIContent("Rotation method", "Specifies the logic that is used to rotate the objects. 'Spherical' will never rotate over 180 degrees to reach the target, ignoring any full rotations. 'Linear' will always rotate linearly to the absolute specified value, even if it means multiple 360 degree spins."));
            ...
            //Checking for extreme values for some properties
            ...
            //If something major was changed, reset the movement
            ...
            //If point space was changed, comvert all anchor points to the new point space
            ...
            //Save the values of all serialized properties
            serializedObject.ApplyModifiedProperties();

            //Resume the movement if it was reset
            if (moved)
            {
                mover.StartMoving();
            }
        ...
        /// <summary>
        /// Draws the list of anchor points along with all relevant controls
        /// </summary>
        private void CustomListField(SerializedProperty waypoints, SerializedProperty rotations)
        {
            expandedAnchorPoint = EditorGUILayout.Foldout(expandedAnchorPoint, "Anchor Points", true);
            anchorPointExpanded.boolValue = expandedAnchorPoint;

            if (expandedAnchorPoint)
            {
                EditorGUI.indentLevel += 1;
