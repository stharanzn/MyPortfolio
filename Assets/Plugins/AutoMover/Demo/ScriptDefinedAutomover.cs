...
{
    /// <summary>
    /// An example of an AutoMover defined using C# script
    /// </summary>
    public class ScriptDefinedAutomover : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //Create AutoMover components and disable RunOnStart, as the AutoMovers are still empty
            ...
            //Add anchor points for the current positions
            mover.AddAnchorPoint();
            childMover.AddAnchorPoint();

            //Add some others nearby
