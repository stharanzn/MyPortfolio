    ...
    return (
        <>
            ...
            <div className="absolute top-10 right-10 w-20 h-20 floating-delay">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-full h-full text-amber-500">
                    <path
                        fill="currentColor"
            ...
            <div className="absolute bottom-20 left-10 w-16 h-16 floating">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-full h-full text-red-400">
