    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-purple-700/20 blur-3xl"></div>
                <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full bg-indigo-700/20 blur-3xl"></div>
            </div>
            ...
            <div className="container mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between">
              ...
              {" "}Interactive Designer
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="#projects" className="btn-primary px-8 py-3 rounded-lg font-medium text-white">
                            View Projects
                        </a>
                        <a
                            href="#contact"
                ...
                <div className="md:w-1/2 relative">
                    <div className="relative w-full h-96 md:h-[500px]">
                        <div
                            className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-purple-600/20 to-indigo-600/20 rounded-2xl"></div>
            ...
            <div className="container mx-auto mt-16 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12">
                    <div className="text-center">
                        ...
                        <div className="text-slate-400">Games Shipped</div>
                    </div>
                    <div className="text-center">
